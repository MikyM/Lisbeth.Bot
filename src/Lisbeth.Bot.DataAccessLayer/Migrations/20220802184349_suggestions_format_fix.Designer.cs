...
namespace Lisbeth.Bot.DataAccessLayer.Migrations
{
    ...
    [Migration("20220802184349_suggestions_format_fix")]
    partial class suggestions_format_fix
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Lisbeth.Bot.Domain.Entities.MemberHistoryEntry", b =>
                {
                    ...
                    b.Property<long?>("PunishmentById")
                        .HasColumnType("bigint")
                        .HasColumnName("punishment_by_id");

                    b.Property<string>("PunishmentByUsername")
                        .HasColumnType("text")
                        .HasColumnName("punishment_by_username");

                    b.Property<string>("PunishmentReason")
                        .HasColumnType("text")
                        .HasColumnName("punishment_reason");
            ...
            modelBuilder.Entity("Lisbeth.Bot.Domain.Entities.Reminder", b =>
                {
                    ...
                    b.Property<bool>("ShouldAddCreationInfo")
                        .HasColumnType("boolean")
                        .HasColumnName("should_add_creation_info");
            ...
            modelBuilder.Entity("Lisbeth.Bot.Domain.Entities.ServerBoosterHistoryEntry", b =>
                {
                    ...
                    b.Property<long>("MemberHistoryEntryId")
                        .HasColumnType("bigint")
                        .HasColumnName("member_history_entry_id");
                    ...
                    b.HasIndex("MemberHistoryEntryId");
            ...
            modelBuilder.Entity("Lisbeth.Bot.Domain.Entities.SuggestionConfig", b =>
                {
                    ...
                    b.Property<bool>("ShouldAddVoteReactions")
                        .HasColumnType("boolean")
                        .HasColumnName("should_add_vote_reactions");

                    b.Property<bool>("ShouldCreateThreads")
                        .HasColumnType("boolean")
                        .HasColumnName("should_create_threads");

                    b.Property<long>("SuggestionChannelId")
                        .HasColumnType("bigint")
                        .HasColumnName("suggestion_channel_id");
                    ...
                    b.ToTable("suggestion_config", (string)null);
                });
            ...
            modelBuilder.Entity("Lisbeth.Bot.Domain.Entities.ServerBoosterHistoryEntry", b =>
                {
                    ...
                    b.HasOne("Lisbeth.Bot.Domain.Entities.MemberHistoryEntry", "MemberHistoryEntry")
                        .WithMany("ServerBoosterHistoryEntries")
                        .HasForeignKey("MemberHistoryEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Lisbeth.Bot.Domain.Entities.SuggestionConfig", b =>
                {
                    b.HasOne("Lisbeth.Bot.Domain.Entities.Guild", "Guild")
                        .WithOne("SuggestionConfig")
                        .HasForeignKey("Lisbeth.Bot.Domain.Entities.SuggestionConfig", "GuildId")
                        .HasPrincipalKey("Lisbeth.Bot.Domain.Entities.Guild", "GuildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
