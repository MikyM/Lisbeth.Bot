...
public struct Optional<T> : IEquatable<Optional<T>>, IEquatable<T>
{
    ...
    public override bool Equals(object? obj)
    {
        ...
        return this.HasValue switch
        {
            false when obj == null => true,
            true => object.Equals(this._value, obj),
            _ => false
        };
    }
    ...
    public bool Equals(Optional<T> other)
    {
        if (!this.HasValue && !other.HasValue)
            return true;
        return this.HasValue == other.HasValue && object.Equals(this._value, other._value);
    }
    ...
    public bool Equals(T? other)
    {
        return this.HasValue switch
        {
            false when other == null => true,
            true => object.Equals(this._value, other),
            _ => false
        };
    }
