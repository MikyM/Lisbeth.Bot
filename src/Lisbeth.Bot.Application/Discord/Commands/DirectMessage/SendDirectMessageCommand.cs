...
public class SendDirectMessageCommand : CommandBase
{
    ...
    {
        Dto = dto;
        RequestedOnBehalfOf = requestedOnBehalfOf;
        Guild = guild;
        RecipientUser = recipientUser;
    }

    public SendDirectMessageReqDto Dto { get; set; }

    public DiscordMember? RequestedOnBehalfOf { get; set; }
    public DiscordMember? RecipientUser { get; set; }
