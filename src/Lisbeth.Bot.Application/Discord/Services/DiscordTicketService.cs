...
namespace Lisbeth.Bot.Application.Discord.Services
{
    ...
    public class DiscordTicketService : IDiscordTicketService
    {
        ...
        private async Task<DiscordMessageBuilder> CloseTicketAsync(DiscordGuild guild, DiscordChannel target, DiscordMember requestingMember, TicketCloseReqDto req)
        {
            if (guild is null) throw new ArgumentNullException(nameof(guild));
