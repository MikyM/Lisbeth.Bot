...
public class DiscordGuildService : IDiscordGuildService
{
        ...
        DiscordMember requestingMember, ReminderConfigReqDto req)
    {
        ...
        var guildRes = await _guildService.AddConfigAsync(req, true);
        ...
        GuildModule type, DiscordMember requestingMember, ReminderConfigRepairReqDto? reminderDto = null)
    {
        ...
        switch (type)
        {
            ...
            case GuildModule.Reminders:
                ...
                guildResult = await _guildService.GetSingleBySpecAsync(
                ...
                var partial = await _guildService.RepairModuleConfigAsync(reminderDto, true);
        ...
        DiscordMember requestingMember, GuildModule type)
    {
        ...
        switch (type)
        {
            ...
            case GuildModule.Reminders:
                ...
                await _guildService.DisableConfigAsync(discordGuild.Id, GuildModule.Reminders, true);
                break;
            default:
                throw new ArgumentOutOfRangeException(nameof(type), type, null);
        }
