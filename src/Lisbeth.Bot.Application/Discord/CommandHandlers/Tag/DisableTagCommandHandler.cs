...
[UsedImplicitly]
public class DisableTagCommandHandler : IAsyncCommandHandler<DisableTagCommand>
{
    ...
    public async Task<Result> HandleAsync(DisableTagCommand command, CancellationToken cancellationToken = default)
    {
