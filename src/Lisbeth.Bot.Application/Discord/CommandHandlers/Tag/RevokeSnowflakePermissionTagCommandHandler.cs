...
[UsedImplicitly]
public class RevokeSnowflakePermissionTagCommandHandler : IAsyncCommandHandler<RevokeSnowflakePermissionTagCommand>
{
    ...
    public async Task<Result> HandleAsync(RevokeSnowflakePermissionTagCommand command, CancellationToken cancellationToken = default)
    {
        var guildRes =
