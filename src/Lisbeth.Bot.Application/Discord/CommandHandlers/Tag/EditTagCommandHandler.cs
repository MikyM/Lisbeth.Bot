...
[UsedImplicitly]
public class EditTagCommandHandler : IAsyncCommandHandler<EditTagCommand>
{
    ...
    public async Task<Result> HandleAsync(EditTagCommand command, CancellationToken cancellationToken = default)
    {
