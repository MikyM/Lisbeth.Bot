...
[UsedImplicitly]
public class RescheduleReminderCommandHandler : IAsyncCommandHandler<RescheduleReminderCommand, DiscordEmbed>
{
    ...
    public async Task<Result<DiscordEmbed>> HandleAsync(RescheduleReminderCommand command, CancellationToken cancellationToken = default)
    {
