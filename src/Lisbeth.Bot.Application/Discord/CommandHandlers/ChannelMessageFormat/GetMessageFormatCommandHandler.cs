...
[UsedImplicitly]
public class GetMessageFormatCommandHandler : IAsyncCommandHandler<GetMessageFormatCommand, DiscordEmbed>
{
    ...
    public async Task<Result<DiscordEmbed>> HandleAsync(GetMessageFormatCommand command, CancellationToken cancellationToken = default)
    {
