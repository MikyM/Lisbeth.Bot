...
namespace Lisbeth.Bot.Application.Discord.SlashCommands
{
    ...
    public class ReminderSlashCommands : ApplicationCommandModule
    {
        ...
        public async Task SingleReminderCommand(InteractionContext ctx,
            [Option("action", "Action to perform")] ReminderActionType actionType,
            [Option("time", "This can be either time or a datetime")] string time,
            [Option("text", "Text for a single reminder")] string text)
        {
        }
        ...
        public async Task RecurringReminderCommand(InteractionContext ctx,
            ...
            [Option("description", "Text for a single reminder")] string description,
            [Option("author", "Author of the embed")] string author,
            [Option("footer", "Footer of the embed")] string footer,
