...
[UsedImplicitly]
public class DiscordAddSnowflakeTicketHandler : IDiscordAddSnowflakeTicketHandler
{
    private readonly IGuildDataService _guildDataService;
    private readonly ITicketDataService _ticketDataService;
    private readonly ILogger<DiscordAddSnowflakeTicketHandler> _logger;
    private readonly IDiscordService _discord;

    public DiscordAddSnowflakeTicketHandler(IGuildDataService guildDataService,
        ILogger<DiscordAddSnowflakeTicketHandler> logger, IDiscordService discord, ITicketDataService ticketDataService)
    {
    ...
    public async Task<Result<DiscordEmbed>> HandleAsync(AddSnowflakeToTicketRequest request)
    {
